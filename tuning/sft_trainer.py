...
def train(
    ...
    if formatted_train_dataset:
        formatted_train_dataset = formatted_train_dataset._resolve_features()
    if formatted_validation_dataset:
        formatted_validation_dataset = formatted_validation_dataset._resolve_features()
    trainer = SFTTrainer(
        model=model,
        tokenizer=tokenizer,
