...
class PromptTuningConfig:
    ...
    tokenizer_name_or_path: str = field(
        default="llama-7b-hf",
        metadata={
            "help": "tokenizer_name_or_path sets tokenizer only for prompt tuning use case.\
                To use custom tokenizer for training, use custom_tokenizer_name_or_path\
                    if not set will default to model_name_or_path for tokenizer"
        },
    )
