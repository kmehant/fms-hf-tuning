...
# head_dim = hidden size // number of heads should be less than 256
hidden_size_p = [2048, 4096]
...
max_seq_length_p = [64, 128, 256, 512, 1024, 2048, 4096, 8192, 16384]

torch_dtype_p = ["bfloat16"]

per_device_bs_p = [1, 2, 3, 4, 8, 16, 32]
